package com.example.vincent8280.calls.db;
...
public class OweList extends DataSupport {
...
//    is_call是手动的
    ...
    public String getJipsuanhuhao() {
        return jipsuanhuhao;
    }

    public void setJipsuanhuhao(String jipsuanhuhao) {
        this.jipsuanhuhao = jipsuanhuhao;
    }
